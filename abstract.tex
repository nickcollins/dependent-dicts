...
deduplicate bindings. Each approach has its pros and cons - chiefly, the new approaches allow contraction and exchange
to be proved easily, while destruction and iteration is easiest with the conventional approach. We also discuss the
meta-theory of dictionaries, which we've defined and proved in the Agda proof assistant.
\end{abstract}
