...
%
association lists allow arbitrary order and may contain duplicates,
%
canonically-ordered association lists must be refined an explicit proof of validity, and
%
...
%
\emph{injective} (there is a one-to-one correspondence between lists and semantic mappings), and
%
\emph{comparable} (lists can be distinguished by primitive equality).
%
Unlike partial functions, delta dictionaries are also \emph{destructible} (the internal representation can be inspected as needed).
%
