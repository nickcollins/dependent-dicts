...
This paper illustrates a novel list-based representation, called \emph{delta dictionaries}, that simultaneously achieves benefits of the conventional representations.
%
Delta dictionaries are \emph{semantically total} (every type-correct list is semantically valid),
%
...
%
Included is an implementation of delta dictionaries in Agda, and a discussion of when delta dictionaries may or may not be preferable to conventional solutions.
