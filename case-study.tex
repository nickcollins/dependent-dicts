...
\rkc{NOTE: We're not entirely sure yet how we want to do the evaluation section, or what is the best way to demonstrate
     ...
     We'd love any feedback on what approach would be most appropriate, useful, and convincing, or on the approach below,
     which is a sort of hypothetical case study, illustrating practical
...
conclusions. The rule for lambda evaluation states that \eval{E}{\lambda x . e}{[E]\lambda x . e}, the result
being a closure over $E$. Using {\SAL}s, \eval{E, (x, a), (x, b)}{\lambda x . e}{[E, (x, a), (x, b)]\lambda x . e}
while \eval{E, (x, b)}{\lambda x . e}{[E, (x, b)]\lambda x . e}; $[E, (x, a), (x, b)]\lambda x . e \ne
