...
%With the finite partial function approach, equality is not decidable in the first
...
%Since the keys in a \dd~ are not represented
...
%\nameref{sec:Evaluation}, leading to soft recommendations about which solution best fits a particular scenario.
