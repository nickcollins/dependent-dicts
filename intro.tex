...
of \emph{functional extensionality}~\mbox{\cite[Logic]{Pierce:SF1}}---consistent with the constructive calculi underlying Coq and Agda---this representation allows for the use of built-in equality for semantic equivalence.
%
