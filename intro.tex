...
\nick{Clarify how funext ensures that semantically equivalent functions are primitively equal, regardless of how you construct the function.}
%
...
%
The function type could be refined with its domain---\ie{}~a canonical list of keys---but would then suffer the drawbacks of manipulating validity proofs \`{a} la canonical association lists.
...
\\ \nick{s/reflexiv/primitiv/g , or something}
