...
%
However, the underlying list type---which allows arbitrary, possibly invalid lists---is not \firstUseGoal{\semanticallyTotal}; a proof of validity is required to refine the coarser type.
%
