...
%
as discussed further in \autoref{sec:Discussion:Generality}.
...
%
However, the underlying list type---which allows arbitrary, possibly invalid lists---is not \firstUseGoal{Semantically Total}; a proof of validity is required to refine the coarser type.
%
...
%
The downsides of having to use validity proofs are discussed further in \autoref{sec:Discussion:Generality}.
