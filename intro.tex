...
of \emph{functional extensionality}~\mbox{\cite[Logic]{Pierce:SF1}}---consistent with the constructive calculi of Coq and Agda---this representation is also \emph{\extensional}.
%
